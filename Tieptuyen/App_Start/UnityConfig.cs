...
namespace Tieptuyen.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IAccessControlRepository, AccessControlRepository>();
            container.RegisterType<IAccessControlService, AccessControlService>(new InjectionConstructor(new AccessControlRepository(), new LanguageManager()));
        }
    }
}
